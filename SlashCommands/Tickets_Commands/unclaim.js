...
module.exports = {
    ...
    data: new SlashCommandBuilder()
        ...
        .setName('unclaim')
        .setDescription('un claimea un ticket'),
    ...
    async run(client, interaction) {
        ...
        interaction.channel.permissionOverwrites.edit(config.rolStaff, {
        ...
        const embed124 = new Discord.EmbedBuilder()
            ...
            .addFields([
                { name: "Ticket", value: `\`\`\`yaml\nEl staff ${interaction.user.tag} ha salido del ticket.\`\`\`` }
            ])
            .setColor(config.colorMain)
        ...
        interaction.reply({ content: "Te has salido del ticket", ephemeral: true })
